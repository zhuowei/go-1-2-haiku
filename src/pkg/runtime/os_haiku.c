...
int32 
runtime·read(int32 a, void* b, int32 c) {
	return 0;
}

int32
runtime·write(int32 a, void* b, int32 c) {
	return 0;
}

int32
runtime·close(int32 a) {
	return 0;
}
...
int32 runtime·open(int8* name, int32 b, int32 c) {
	return 0;
}

G* runtime·netpoll(bool a) {
	return (void*) 0;
}

void runtime·setitimer(int32 a, Itimerval* b, Itimerval* c) {
}

void runtime·sighandler(int32 sig, Siginfo* info, void* ctxt, G* gp) {
}
